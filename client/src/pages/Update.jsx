            ...
            <div className='flex flex-col items-center  bg-[#f0eee2] w-full h-850 rounded-[70px] p-[70px]'>
                    ...
                    <div className='flex flex-col w-5/12'>
                        <div className=''>
                            <div className='flex flex-col'>
                                ...
                                <input onChange={handleChange} type="text" placeholder='name' name='name'
                                    className='bg-transparent border border-black rounded-xl px-3 py-2 placeholder-zinc-700 focus:outline-none' />
                ...
                <div className='w-full flex justify-around mt-[4%]'>
                    <div className='w-5/12'>
                        ...
                        <textarea onChange={handleChange} type="textarea" placeholder='description' name='description'
                            className='bg-transparent border border-black rounded-xl px-3 py-3 w-full  placeholder-zinc-700 focus:outline-none h-[140px]' />
                    </div>
                    <div className=' w-5/12 flex flex-col'>
                        ...
                        <input onChange={handleChange} type="number" placeholder='price' name='price'
                            className='bg-transparent border border-black rounded-xl px-3 py-2 placeholder-zinc-700 focus:outline-none' />
                        <button onClick={handleSubmit} className='bg-black text-white rounded-xl mt-9 px-3 py-3 text-[20px]'>Update</button>
                    </div>
                </div>
