                    ...
                    <div className='w-full flex justify-around mt-[4%]'>
                        ...
                        <div className=' w-5/12 flex flex-col'>
                            ...
                            <input onChange={handleChange} type="number" placeholder='price' name='price'
                                className='bg-[#f0eee2] rounded-xl px-3 py-2 placeholder-zinc-700 focus:outline-none' />
                            <button onClick={handleSubmit} className='bg-black text-white rounded-xl mt-9 px-3 py-3 text-[20px] hover:scale-110 hover:duration-150 hover:shadow-xl'>Update</button>
                        </div>
                    </div>
                </div>
            </div>
