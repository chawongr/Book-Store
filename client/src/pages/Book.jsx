                    ...
                    <div className='flex flex-col items-center bg-[#f0eee2] w-[1000px] h-[550px] rounded-[70px] p-[50px] relative'>
                        ...
                        <div className='w-full flex justify-between mt-7'>
                            <div className=' w-1/2'>
                                ...
                                <div className='text-[16px] font-light mt-3 overflow-auto h-[140px] '>{selectedBook.description}</div>
                            </div>
                            <div className=' w-5/12'>
                                ...
                                <div className='flex flex-row mt-3 justify-end'>
                                    ...
                                    <button className='text-white bg-[#e16868] rounded-full w-fit px-6 py-2 ml-3 text-[16px] hover:bg-black hover:scale-110 hover:duration-150 shadow-xl' onClick={() => handleDelete(selectedBook.id)}>
                                        Delete
                                    </button>
                                </div>
                            </div>
